...
/* Changed all USART2 instances to USART3 partial remap Port C */

#include "stm32-slcan.h"

#define BUFFER_SIZE 2048
#define USART3_SPEED 500000
...
void usart_setup(void)
{
    ...
    gpio_primary_remap(AFIO_MAPR_SWJ_CFG_JTAG_OFF_SW_ON, AFIO_MAPR_USART3_REMAP_PARTIAL_REMAP);
    ...
    usart_set_baudrate(USART3, USART3_SPEED);
...
void usart3_isr(void)
{
    ...
    if (((USART_CR1(USART3) & USART_CR1_TXEIE) != 0) && ((USART_SR(USART3) & USART_SR_TXE) != 0))
    {
